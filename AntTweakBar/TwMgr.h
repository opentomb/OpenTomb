...
/*ANT_TWEAK_BAR_API*/ int       TwSetBarState(TwBar *bar, TwState state);
/*ANT_TWEAK_BAR_API*/ //TwState TwGetBarState(const TwBar *bar);
// var states -> use TwDefine instead: visible/iconified implemented only as string commands
//ANT_TWEAK_BAR_API int     TwSetVarState(TwBar *bar, const char *name, TwState state);
//ANT_TWEAK_BAR_API TwState TwGetVarState(const TwBar *bar, const char *name);

struct CTwVarGroup;
typedef void (*TwStructExtInitCallback)(void *structExtValue, void *clientData);
typedef void (*TwCopyVarFromExtCallback)(void *structValue, const void *structExtValue, unsigned int structExtMemberIndex, void *clientData);
typedef void (*TwCopyVarToExtCallback)(const void *structValue, void *structExtValue, unsigned int structExtMemberIndex, void *clientData);
/*ANT_TWEAK_BAR_API*/ TwType    TwDefineStructExt(const char *name, const TwStructMember *structExtMembers, unsigned int nbExtMembers, size_t structSize, size_t structExtSize, TwStructExtInitCallback structExtInitCallback, TwCopyVarFromExtCallback copyVarFromExtCallback, TwCopyVarToExtCallback copyVarToExtCallback, TwSummaryCallback summaryCallback, void *clientData, const char *help);
typedef void (*TwCustomDrawCallback)(int w, int h, void *structExtValue, void *clientData, TwBar *bar, CTwVarGroup *varGrp);
typedef bool (*TwCustomMouseMotionCallback)(int mouseX, int mouseY, int w, int h, void *structExtValue, void *clientData, TwBar *bar, CTwVarGroup *varGrp);
typedef bool (*TwCustomMouseButtonCallback)(TwMouseButtonID button, bool pressed, int mouseX, int mouseY, int w, int h, void *structExtValue, void *clientData, TwBar *bar, CTwVarGroup *varGrp);
typedef void (*TwCustomMouseLeaveCallback)(void *structExtValue, void *clientData, TwBar *bar);
...
struct CTwMgr
{
    ...
    struct CStruct
    {
        ...
        CStruct() : m_IsExt(false), m_StructExtInitCallback(NULL), m_CopyVarFromExtCallback(NULL), m_CopyVarToExtCallback(NULL), m_ExtClientData(NULL), m_Size(0), m_SummaryClientData(0), m_ClientStructSize(0) {}
        static void        DefaultSummary(char *_SummaryString, size_t _SummaryMaxLength, const void *_Value, void *_ClientData);
    ...
    struct CMemberProxy
    {
        ...
        CMemberProxy();
        ~CMemberProxy();
        static void SetCB(const void *_Value, void *_ClientData);
        static void GetCB(void *_Value, void *_ClientData);
    };
...
extern "C" int TwSetLastError(const char *_StaticErrorMessage);
...
struct CColorExt
{
    ...
    void                 RGB2HLS();
    void                 HLS2RGB();
    static void InitColor32CB(void *_ExtValue, void *_ClientData);
    static void InitColor3FCB(void *_ExtValue, void *_ClientData);
    static void InitColor4FCB(void *_ExtValue, void *_ClientData);
    static void CopyVarFromExtCB(void *_VarValue, const void *_ExtValue, unsigned int _ExtMemberIndex, void *_ClientData);
    static void CopyVarToExtCB(const void *_VarValue, void *_ExtValue, unsigned int _ExtMemberIndex, void *_ClientData);
    static void SummaryCB(char *_SummaryString, size_t _SummaryMaxLength, const void *_ExtValue, void *_ClientData);
...
struct CQuaternionExt
{
    ...
    CTwMgr::CStructProxy*m_StructProxy;
    static void InitQuat4FCB(void *_ExtValue, void *_ClientData);
    static void InitQuat4DCB(void *_ExtValue, void *_ClientData);
    static void InitDir3FCB(void *_ExtValue, void *_ClientData);
    static void InitDir3DCB(void *_ExtValue, void *_ClientData);
    static void CopyVarFromExtCB(void *_VarValue, const void *_ExtValue, unsigned int _ExtMemberIndex, void *_ClientData);
    static void CopyVarToExtCB(const void *_VarValue, void *_ExtValue, unsigned int _ExtMemberIndex, void *_ClientData);
    static void SummaryCB(char *_SummaryString, size_t _SummaryMaxLength, const void *_ExtValue, void *_ClientData);
    static void DrawCB(int _W, int _H, void *_ExtValue, void *_ClientData, TwBar *_Bar, CTwVarGroup *varGrp);
    static bool MouseMotionCB(int _MouseX, int _MouseY, int _W, int _H, void *_StructExtValue, void *_ClientData, TwBar *_Bar, CTwVarGroup *varGrp);
    static bool MouseButtonCB(TwMouseButtonID _Button, bool _Pressed, int _MouseX, int _MouseY, int _W, int _H, void *_StructExtValue, void *_ClientData, TwBar *_Bar, CTwVarGroup *varGrp);
    static void MouseLeaveCB(void *_StructExtValue, void *_ClientData, TwBar *_Bar);
    static void          CreateTypes();
