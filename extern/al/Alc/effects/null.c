 ...
 * not replace it.
 */
static ALvoid ALnullState_process(ALnullState* UNUSED(state), ALuint UNUSED(samplesToDo), const ALfloat *__restrict__ UNUSED(samplesIn), ALfloat (*__restrict__ samplesOut)[BUFFERSIZE])
{
