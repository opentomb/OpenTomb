...
struct MidiSynthVtable {
    ...
    void (*const process)(MidiSynth *self, ALuint samples, ALfloat (*__restrict__ DryBuffer)[BUFFERSIZE]);
...
DECLARE_THUNK2(T, MidiSynth, void, process, ALuint, ALfloatBUFFERSIZE*__restrict__) \
