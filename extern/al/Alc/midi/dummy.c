...
static void DSynth_process(DSynth *self, ALuint SamplesToDo, ALfloat (*__restrict__ DryBuffer)[BUFFERSIZE]);
...
static void DSynth_process(DSynth *self, ALuint SamplesToDo, ALfloatBUFFERSIZE*__restrict__ UNUSED(DryBuffer))
{
