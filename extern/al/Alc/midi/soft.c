...
static void SSynth_mixSamples(SSynth *self, ALuint SamplesToDo, ALfloat (*__restrict__ DryBuffer)[BUFFERSIZE]);
...
static void SSynth_process(SSynth *self, ALuint SamplesToDo, ALfloat (*__restrict__ DryBuffer)[BUFFERSIZE]);
...
static void SSynth_mixSamples(SSynth* UNUSED(self), ALuint UNUSED(SamplesToDo), ALfloatBUFFERSIZE *__restrict__ UNUSED(DryBuffer))
{
}
