...
const ALfloat *Resample_copy32_C(const ALfloat *src, ALuint UNUSED(frac),
  ALuint increment, ALfloat *__restrict__ dst, ALuint numsamples)
{ 
...
void ALfilterState_processC(ALfilterState *filter, ALfloat *__restrict__ dst, const ALfloat *src, ALuint numsamples)
{
    ALuint i;
    for(i = 0;i < numsamples;i++)
...
static inline void ApplyCoeffsStep(ALuint Offset, ALfloat (*__restrict__ Values)[2],
                                   const ALuint IrSize,
...
static inline void ApplyCoeffs(ALuint Offset, ALfloat (*__restrict__ Values)[2],
                               const ALuint IrSize,
                               ALfloat (*__restrict__ Coeffs)[2],
                               ALfloat left, ALfloat right)
{
