...
-- enabled keys for debug (1=true, 0=false)
local DEBUG_MODE = 1;
...
print("autoexec.lua->misc loaded !");
...
addItem(player, ITEM_PICKUP_1, 1);
addItem(player, ITEM_PICKUP_2, 1);
addItem(player, ITEM_PICKUP_3, 1);
addItem(player, ITEM_PICKUP_4, 1);
