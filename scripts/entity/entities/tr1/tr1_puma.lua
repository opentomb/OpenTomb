function tr1_puma_init(id)
    ...
    setCharacterParam(id, PARAM_HEALTH, TR1_PUMA, TR1_PUMA);
    ...
    entity_funcs[id].onAttack = function(object_id, activator_id)
        ...
        if(bone == 20 or bone == 21 or bone == 2 or bone == 3 or bone == 5 or bone == 6) then
            setCharacterParam(object_id, PARAM_HIT_DAMAGE, TR1_PUMA_DMG * frame_time, TR1_PUMA_DMG * frame_time);
