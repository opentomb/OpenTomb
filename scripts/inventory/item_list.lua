...
ITEM_UZI_AMMO = 34
ITEM_M16_AMMO = 35
ITEM_GRENADEGUN_AMMO = 36
ITEM_ROCKETGUN_AMMO = 37
ITEM_HARPOONGUN_AMMO = 38
ITEM_CROSSBOW_NORMAL_AMMO = 39
ITEM_CROSSBOW_POISON_AMMO = 40
ITEM_CROSSBOW_EXPLOSIVE_AMMO = 41
ITEM_GRAPPLEGUN_AMMO = 42

ITEM_FLARES = 43
ITEM_SINGLE_FLARE = 44
