...
elseif(ver < TR_III) then
    ...
    createBaseItem(ITEM_MAGNUM_AMMO, 166, 166, ITEM_TYPE_SUPPLY, 40, ITEM_NAME_MAGNUM_AMMO);
...
elseif(ver < TR_IV) then
    ...
    createBaseItem(ITEM_MAGNUM_AMMO, 195, 170, ITEM_TYPE_SUPPLY, 10, ITEM_NAME_MAGNUM_AMMO);
...
elseif(ver < TR_V) then
    ...
    createBaseItem(ITEM_MAGNUM_AMMO, 367, 367, ITEM_TYPE_SUPPLY, 6, ITEM_NAME_MAGNUM_AMMO);
