...
function genBaseItems()
    ...
    elseif(ver == Engine.II) then
        ...
        createBaseItem(ITEM_GRENADEGUN_NORMAL_AMMO, 170, 170, ITEM_TYPE_SUPPLY, 2, ITEM_NAME_GRENADEGUN_NORMAL_AMMO);
    ...
    elseif(ver == Engine.III) then
        ...
        createBaseItem(ITEM_GRENADEGUN_NORMAL_AMMO, 200, 175, ITEM_TYPE_SUPPLY, 2, ITEM_NAME_GRENADEGUN_NORMAL_AMMO);
