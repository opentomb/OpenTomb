...
static_tbl[07] = {coll = COLLISION_TYPE_NONE,   shape = COLLISION_SHAPE_BOX};           -- Hanging plant
...
static_tbl[45] = {coll = COLLISION_TYPE_NONE,   shape = COLLISION_SHAPE_BOX};           -- Skeleton
static_tbl[48] = {coll = COLLISION_TYPE_NONE,   shape = COLLISION_SHAPE_BOX};           -- Skeleton
