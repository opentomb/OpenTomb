...
static_tbl[01] = {coll = BBOX};       -- Flower pot 02
static_tbl[02] = {coll = BBOX};       -- Flower pot 03
...
static_tbl[08] = {coll = MESH};       -- Sofa
static_tbl[09] = {coll = BBOX};       -- Fish statue
static_tbl[10] = {coll = MESH};       -- Chair
static_tbl[11] = {coll = BBOX};       -- Fireplace
static_tbl[12] = {coll = MESH};       -- Harp
static_tbl[13] = {coll = MESH};       -- Piano
static_tbl[14] = {coll = MESH};       -- Desk
static_tbl[15] = {coll = BBOX};       -- Woman statue
