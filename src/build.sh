...
rm -rf *.o
echo "(7/9)    'bullet' lib building complete"
"gcc" -c "*.c"
...
"g++" -o "engine.exe" -static -lmingw32 -limagee -lSDL2main -lSDL2.dll -L"../lib/." -lvte -lluae "*.o" -lopenale -lSDL2main -lSDL2.dll -lvte -lftgle -lfreetype2e -lluae -lbullete -lglu32 -lopengl32 -lz -lpthread
rm -rf *.o
