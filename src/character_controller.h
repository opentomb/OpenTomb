...
#define BODY_PART_BODY_LOW      (0x00000001)
#define BODY_PART_BODY_UPPER    (0x00000002)
#define BODY_PART_HEAD          (0x00000004)

#define BODY_PART_LEFT_HAND_1   (0x00000008)
#define BODY_PART_LEFT_HAND_2   (0x00000010)
#define BODY_PART_LEFT_HAND_3   (0x00000020)
#define BODY_PART_RIGHT_HAND_1  (0x00000040)
#define BODY_PART_RIGHT_HAND_2  (0x00000080)
#define BODY_PART_RIGHT_HAND_3  (0x00000100)

#define BODY_PART_LEFT_LEG_1    (0x00000200)
#define BODY_PART_LEFT_LEG_2    (0x00000400)
#define BODY_PART_LEFT_LEG_3    (0x00000800)
#define BODY_PART_RIGHT_LEG_1   (0x00001000)
#define BODY_PART_RIGHT_LEG_2   (0x00002000)
#define BODY_PART_RIGHT_LEG_3   (0x00004000)
#define BODY_PART_TAIL          (0x00008000)
...
typedef struct character_s
{
    ...
    int                         currentAmmunitionInventoryItemId;
