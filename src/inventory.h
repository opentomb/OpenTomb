...
#define ITEM_M16        17  // Exists since TR2, aka MP5 in TR3, aka H&K in TR5
#define ITEM_MP5        18
#define ITEM_GRENADEGUN 19  // Exists since TR2, through all game versions
#define ITEM_ROCKETGUN  20  // Exists in TR3 only
#define ITEM_HARPOONGUN 21  // Exists in TR2-3 only
...
#define ITEM_SHOTGUN_NORMAL_AMMO 28
#define ITEM_SHOTGUN_WIDESHOT_AMMO 29
#define ITEM_MAGNUM_AMMO 30
#define ITEM_DESERTEAGLE_AMMO 31
#define ITEM_AUTOMAGS_AMMO 32
#define ITEM_REVOLVER_AMMO 33
#define ITEM_UZI_AMMO 34
#define ITEM_M16_AMMO 35
#define ITEM_MP5_AMMO 36
#define ITEM_GRENADEGUN_NORMAL_AMMO 37
#define ITEM_GRENADEGUN_SUPER_AMMO 38
#define ITEM_GRENADEGUN_FLASH_AMMO 39
#define ITEM_ROCKETGUN_AMMO 40
#define ITEM_HARPOONGUN_AMMO 41
#define ITEM_CROSSBOW_NORMAL_AMMO 42
#define ITEM_CROSSBOW_POISON_AMMO 43
#define ITEM_CROSSBOW_EXPLOSIVE_AMMO 44
#define ITEM_GRAPPLEGUN_AMMO 45

#define ITEM_FLARES 46
#define ITEM_SINGLE_FLARE 47
#define ITEM_TORCH 48

#define ITEM_SMALL_MEDIPACK 49
#define ITEM_LARGE_MEDIPACK 50
