...
#define ITEM_VIDEO    2     // Video settings. Exists only in TR1-3.
#define ITEM_AUDIO    3     // Audio settings. Exists only in TR1-3.
#define ITEM_CONTROLS 4     // Control settings. Exists only in TR1-3.
#define ITEM_LOAD     5     // Load game. Exists only in TR4-5.
#define ITEM_SAVE     6     // Save game. Exists only in TR4-5.
...
#define ITEM_CROSSBOW   18  // Exists in TR4 only
#define ITEM_GRAPPLEGUN 19  // Exists in TR5 only
...
#define ITEM_GRAPPLEGUN_AMMO 44
