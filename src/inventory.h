...
#define ITEM_GRENADEGUN_AMMO 36     // Exist only in TR2-3. Prevents the compass item to be erroneously mixed with the grenade item (@TBF)
#define ITEM_GRENADEGUN_NORMAL_AMMO 35
