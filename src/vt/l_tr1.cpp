...
void TR_Level::load()
{
    ...
    m_src.readVector(m_rooms, m_src.readU16(), &tr5_room_t::readTr1);
    ...
    m_src.readVector(m_boxes, m_src.readU32(), &tr_box_t::readTr1);
    ...
    m_src.readVector(m_items, m_src.readU32(), &tr2_item_t::readTr1);
