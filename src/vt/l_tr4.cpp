...
void TR_Level::read_tr4_level(SDL_RWops * const _src)
{
    ...
    this->overlaps.resize(read_bitu32(newsrc));
    ...
    this->items.resize(read_bitu32(newsrc));
