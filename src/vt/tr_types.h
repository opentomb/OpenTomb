...
typedef struct tr5_room_s
{
    ...
    tr2_colour_t light_colour;    // Present in TR4 and TR5 only
...
typedef struct tr_sound_details_s
{                         // 8 bytes
...
/** \brief Animated Textures.
  */
typedef struct tr_animated_textures_s
{
